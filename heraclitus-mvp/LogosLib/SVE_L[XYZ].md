...
Use code with caution.[ Informal Fallacy ] ──► [ 1. Formal Definition ] ──► [ 2. Markdown Spec ] ──► [ 3. Rust Core PR ](e.g., Red Herring)      (First-Order Logic)         (lemmas/SVE-LXXX.md)      (src/engine.rs Node)
...
```logos-spec
CONSTANT CONTRIBUTING_Context : Scope
VARIABLE CONTRIBUTING_Assertion : Prop

DEF CONTRIBUTING.check (s : Scope) : Prop :=
