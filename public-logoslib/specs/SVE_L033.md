...
triggers: ["the complex"]
ep_hash: sle_sha256_auto_fedfd3bfc4d2077b
---
...
```sve
DECLARE_LEMMA(SVE_L033) {
  MATCH_CONTEXT(Rhetorical_Pattern["the complex"]);
...
```logos-spec
CONSTANT SVE_L033_auto_generated_Context : Scope
VARIABLE SVE_L033_auto_generated_Assertion : Prop

DEF SVE_L033_auto_generated.check (s : Scope) : Prop :=
