...
**Topic:** #lemma-proposals ──► Thread: `[SVE-L104] Ad Hominem Tu Quoque`
...
> *"CRITIC REJECTION: ID collision detected. Lemma SVE-L104 is already locked in memory."*
...
*   **Analysis:** Consider re-indexing proposal sequence to avoid monorepo namespace collision.
...
```logos-spec
CONSTANT SVE_L104_ZULIP_REJECTION_REPORT_Context : Scope
VARIABLE SVE_L104_ZULIP_REJECTION_REPORT_Assertion : Prop

DEF SVE_L104_ZULIP_REJECTION_REPORT.check (s : Scope) : Prop :=
