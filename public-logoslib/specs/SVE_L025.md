...
triggers: ["the big"]
ep_hash: sle_sha256_auto_3c69882d4ee936d6
---
...
```logos-spec
CONSTANT SVE_L025_auto_generated_Context : Scope
VARIABLE SVE_L025_auto_generated_Assertion : Prop

DEF SVE_L025_auto_generated.check (s : Scope) : Prop :=
